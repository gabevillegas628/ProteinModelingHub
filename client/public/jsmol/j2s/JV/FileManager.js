...
function(){
if (JV.FileManager.staticJmolDataReader == null) JV.FileManager.staticJmolDataReader = J.adapter.smarter.Resolver.getReader("JmolData", null);
return JV.FileManager.staticJmolDataReader;
});
c$.SIMULATION_PROTOCOL = "http://SIMULATION/";
c$.scriptFilePrefixes =  Clazz.newArray(-1, ["/*file*/\"", "FILE0=\"", "FILE1=\""]);
c$.staticJmolDataReader = null;
});
